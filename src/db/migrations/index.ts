...
import { migration_0001_enforceNonNullPinnedObjects } from './0001_enforce_nonnull_pinnedObjects'

const migrations: Migration[] = [migration_0001_enforceNonNullPinnedObjects]
