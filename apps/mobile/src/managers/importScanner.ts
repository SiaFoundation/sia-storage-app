...
/**
 * Computes how many tier-2 (deferred photo copy) files the scanner should
 * process this tick. When the upload backlog is full, returns 0 so the
 * scanner stops copying new photos and avoids filling device storage.
 */
