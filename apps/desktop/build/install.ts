...
/**
 * Whether the path is free, or holds a shim this packaging wrote before. The
 * whole generated form is matched, not a substring: a user's own script that
 * happens to mention `daemon.js` must not count as ours.
 */
