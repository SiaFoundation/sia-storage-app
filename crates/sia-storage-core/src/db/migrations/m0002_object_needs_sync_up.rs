...
pub fn migration_0002_object_needs_sync_up() -> Migration {
    Migration {
        id: "0002_object_needs_sync_up".into(),
        description: "Add a per-object needsSyncUp dirty flag for sync-up.".into(),
        up,
    }
}
...
mod tests {
    use super::*;
    use crate::db::migrations::m0001_init_schema::migration_0001_init_schema;
    ...
    fn backfill_flags_existing_objects_as_needing_sync_up() {
        ...
        run_migrations(&mut conn, &[migration_0001_init_schema()]).unwrap();
        conn.execute(
